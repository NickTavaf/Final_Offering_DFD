...
function convertToParticles() {
    ...
    const paragraph = "The Offering I created is an interactive website that shows a list of the names of people who were killed in Gaza. Each name appears on the screen, but when you try to hover over it with your mouse, the name disappears. The design is simple but intentional. It's supposed to reflect the way manny of these deaths are briefly reported and then forgotten. The act of moving the mouse, something small and easy becomes an act of erasure and forgetness. I want the viewer to experience this tension between remembering and losing. Even though the names vanish visually, they remain in the code, always present in the structure of the site and always going to reappear. This mirrors the idea that memory and mourning can exist even when it's not publicly visible.";
